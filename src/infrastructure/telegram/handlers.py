    ...
    *,
    ...
    async def start_handler(
        ...
        await message.answer(
            ...
            "Запоминаю факты о тебе и нахожу их позже.\n"
            "Например: «Запомни, что я перешёл в компанию B», "
            "«Какой фильм я хотел посмотреть?».\n"
            "Спроси «что ты умеешь», чтобы узнать остальное.\n\n"
            "Задачи и календарь:\n"
